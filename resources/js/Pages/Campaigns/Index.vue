                    ...
                    <div class="w-full p-4 bg-white border border-gray-200 rounded-lg shadow sm:p-8 dark:bg-gray-800 dark:border-gray-700">
                        <div class="flow-root">
                            ...
                            <div class="relative overflow-x-auto shadow-md sm:rounded-lg">
                                ...
                                <PrimaryButton class="ms-3" @click="runCampaigns" title="This will run all campaigns that meets given criteria.">Run <i class="fa fa-play ml-1" /></PrimaryButton>
                                <table class="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
                                    ...
                                    <tbody>
                                        <tr v-for="campaign in campaigns" :key="campaign.id" class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                                            ...
                                            <td class="px-6 py-4">
                                                <span v-if="campaign.start_time">{{ new Date(campaign.start_time)?.toLocaleDateString('sl-SI') }}</span>
                                            </td>
