                    ...
                    <template #filters>
                        <div class="relative">
                            <div class="flex gap-2 flex-wrap overflow-hidden"
                                ...
                                ref="el">
                                <div class="gap-2 flex" v-for="(selectedValue, index) in queryFilters">
                                    <Pill :key="selectedValue" v-if="getValue(selectedValue)" color="secondary"
                                        :contentClasses="['px-2', 'py-1']" :dismissable="true"
                                ...
                                <div v-if="!hiddenFilters && queryFilters.length > count"
                            ...
                            <div v-if="hiddenFilters && queryFilters.length > count" @click="showMoreFilters"
